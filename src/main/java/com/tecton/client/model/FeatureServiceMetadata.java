...
public class FeatureServiceMetadata {
   ...
   * com.tecton.client.request.GetFeaturesRequest} for the feature service
   *
   * @return Returns a {@link java.util.List} of {@link com.tecton.client.model.NameAndType}
   ...
   * for a {@link com.tecton.client.request.GetFeaturesRequest} for the feature service
   *
   * @return Returns a {@link java.util.List} of {@link com.tecton.client.model.NameAndType}
   ...
   *
   * @return Returns a {@link java.util.List} of {@link com.tecton.client.model.NameAndType}
   *     representing the feature metadata
   */
