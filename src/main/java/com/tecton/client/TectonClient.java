...
public class TectonClient {
   ...
   *     href="https://docs.tecton.ai/latest/examples/fetch-real-time-features.html#authenticating-with-an-api-key/">Authenticating
   *     with an API key</a> for more information
   * @param tectonClientOptions A {@link com.tecton.client.TectonClientOptions} object with custom
   *     comfigurations
   */
   ...
   * com.tecton.client.response.GetFeaturesResponse} object
   *
   * @param getFeaturesRequest A {@link com.tecton.client.request.GetFeaturesRequest} object with
   *     the request parameters
   * @return {@link com.tecton.client.response.GetFeaturesResponse} object representing the response
   *     from the HTTP API
   ...
   * com.tecton.client.response.GetFeatureServiceMetadataResponse} object
   *
   * @param getFeatureServiceMetadataRequest A {@link
   *     com.tecton.client.request.GetFeatureServiceMetadataRequest} object with the request
   *     parameters
   * @return {@link com.tecton.client.response.GetFeatureServiceMetadataResponse} object
   *     representing the response * from the HTTP API
   * @throws TectonClientException when the client encounters an error while building the request or
   *     * parsing the response
   * @throws TectonServiceException when the client receives an error response from the HTTP API
   */
